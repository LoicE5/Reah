    ...
    <main class="main_content">
        ...
        <div class="fb">
            ...
            <div class="settings_menu">
                ...
                <div class="settings_menu_option settings_menu_option_security" number="3">Sécurité et confidentialité
                </div>
            </div>
            ...
            <div class="settings_container settings_notification_container" number="1">
                ...
                <div class="like_container">
                    ...
                    <div>
                        <p>Mentions J'aime sur les commentaires<br> <span>Jean-Eude a aimé votre commentaire.</span></p>
                        <div class="notification_btn">
                            <div></div>
                        </div>
                    </div>
                    <div>
                        <p>Mentions J'aime sur les court-métrage où vous êtes identifié<br> <span>Jean-Eude a aimé un
            ...
            <div class="settings_container settings_account_container" number="2">
                ...
                <div>
                    ...
                    <p>Les autres utilisateurs ne pourront plus voir vos œuvres ni voir votre profil mais vous pourrez
                        récupérer votre compte à tout moment. </p>
                </div>

                <div>
                    <p class="delete_link">Supprimer mon compte reah</p>
                    <p>Les autres utilisateurs pourront plus voir vos œuvres ni voir votre profil. Vous ne pourrez pas
